...
**Built with:** Python, LangChain, Google Gemini (Flash-Latest), FAISS, and Streamlit.
...
5.  **Generation:** Powered by Google's **Gemini Flash-Latest** model for low-latency inference.
...
cd genAI-personal-projects/01_Resume_RAG_Agent
